          ...
          if(isset($_SESSION['name'])){
            echo '<div class="ml-auto d-flex">
                    <a class="nav-link" href="dashboard.php">
                      <span class="fas fa-user-circle pr-2"></span>'.$_SESSION['name'].
                    '</a>
                    <a href="signout.php" class="btn btn-outline-danger mx-md-1 px-md-4 px-5">
            ...
            echo '<div class="ml-auto d-flex">
                    ...
                    <a href="./signup.php" class="btn btn-primary mx-md-1 px-md-4 px-5">
                      <i class="fas fa-user-plus pr-2"></i>Signup
                    </a>
                  </div>';
          }
